    ...
    <>
      ...
      >
        <div className="grid grid-cols-3 grid-rows-6  gap-2 max-h-screen ">
          ...
          <div class="flex flex-col gap-2 dark:text-white max-w-md w-full bg-white dark:bg-neutral-900 p-5 rounded-md mt-8 shadow-md hover:scale-105 hover:duration-150 duration-150">
            ...
            <div class="text-sm">
              ...
              lacinia odio vitae vestibulum. Donec in efficitur ipsum, sed
              dapibus eros.
            </div>
          </div>
